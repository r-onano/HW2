 ...
 * Most of the code is based on the starter code provided by the Professor. My addition to the class is the code for the methods 
 * averageHelper, nodesGTHelper, findMinHelper, replaceValueHelper.
 * The code for the implementation of nodesGTHelper is based on code generated by AI and modified by me to fit the specifications.***
 *
...
public class BinaryTree {
    ...
    private int[] averageHelper(Node node) {
        ...
        if (node == null) {
            ...
            // Sum
            result[0] = node.data + leftData[0] + rightData[0];
            // Count
